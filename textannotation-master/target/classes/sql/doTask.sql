...
CREATE TABLE `dt_classify` (
  ...
  `dt_id` int(11) NOT NULL COMMENT '做任务ID',
  `label_id` int(11) DEFAULT NULL COMMENT '做任务详细描述标签ID',
  `goodlabel` int(11) NOT NULL COMMENT '点赞个数',
  `badlabel` int(11) NOT NULL COMMENT '点踩个数',
  PRIMARY KEY (`dtd_id`),
  FOREIGN KEY (`dt_id`) REFERENCES `d_paragraph` (`dtid`),
  FOREIGN KEY (`label_id`) REFERENCES `label` (`lid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

INSERT INTO `dt_classify` VALUES ('1', '1','1','0','0');
INSERT INTO `dt_classify` VALUES ('2', '1','1','0','0');
INSERT INTO `dt_classify` VALUES ('3', '1','1','0','0');
INSERT INTO `dt_classify` VALUES ('4', '7','4','0','0');
INSERT INTO `dt_classify` VALUES ('5', '8','5','0','0');
INSERT INTO `dt_classify` VALUES ('6', '9','4','0','0');
